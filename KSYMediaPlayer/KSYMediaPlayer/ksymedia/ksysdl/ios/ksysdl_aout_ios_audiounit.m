...
#include "ksysdl_aout_ios_audiounit.h"

#include <stdbool.h>
#include <assert.h>
#include "ksysdl/ksysdl_inc_internal.h"
...
typedef struct SDL_Aout_Opaque {
    KSYSDLAudioQueueController *aoutController;
} SDL_Aout_Opaque;
...
int aout_open_audio(SDL_Aout *aout, SDL_AudioSpec *desired, SDL_AudioSpec *obtained)
{
    ...
    opaque->aoutController = [[KSYSDLAudioQueueController alloc] initWithAudioSpec:desired];
