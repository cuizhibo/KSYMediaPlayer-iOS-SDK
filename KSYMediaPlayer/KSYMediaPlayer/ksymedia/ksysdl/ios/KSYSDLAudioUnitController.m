...
#import "KSYSDLAudioUnitController.h"
#include "ksyutil/ksyutil.h"
#import "KSYSDLAudioKit.h"

@implementation KSYSDLAudioUnitController {
    AudioUnit _auUnit;
    BOOL _isPaused;
}
...
- (id)initWithAudioSpec:(SDL_AudioSpec *)aSpec
{
    ...
    if (self) {
        ...
        KSYSDLGetAudioComponentDescriptionFromSpec(&_spec, &desc);
...
{
    @autoreleasepool {
        KSYSDLAudioUnitController* auController = (__bridge KSYSDLAudioUnitController *) inRefCon;
